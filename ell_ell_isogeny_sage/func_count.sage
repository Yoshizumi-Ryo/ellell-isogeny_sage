...
def Count_later_codomain(count_max,N_A,tc_0,tc_f1,tc_f2,tc_f12,tc_x,tc_xpf1,tc_xpf2,K,number):
...
def Count_later_evaluation(count_from,count_max,N_A,tc_0,tc_f1,tc_f2,tc_f12,tc_x,tc_xpf1,tc_xpf2,K,number):
    assert(number==1 or number==2 or number==3)
    ell_list=[]
    e_list=[]
    for l in range(count_from,count_max+1):
