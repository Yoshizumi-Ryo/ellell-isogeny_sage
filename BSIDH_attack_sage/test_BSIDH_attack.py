...
print("p=",p)
print("bit length of p=",len(p.digits(2)))
print("N_A=",N_A)
print("N_B=",N_B)
print("isogeny_type",isogeny_type)
...
#Main attack.=========================
print("Main attack.")
Attacker_ker=Main_Attack(E_0m,E_B,E_pr,N_A,N_B,P_A,Q_A,PA_EB,QA_EB,alpha_PA,alpha_QA,zeta_4,isogeny_type)
#=====================================
